...
# === Step 1: Load Graph from Neo4j as an Undirected Graph ===
def load_graph_from_neo4j(uri, user, password):
    ...
    with driver.session() as session:
        # Query directed relationships from Neo4j.
        # We consider both directions (i.e. traverse both outgoing and incoming)
        result = session.run("""
            MATCH (a)-[r]->(b)
